...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ua.com.ipublisher.customize.tab.group.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','UaComIpublisherCustomizeTabGroupModuleAssets.m')
